    ...
    <form method="GET" action="{{ route('presensi.index') }}" id="filterForm">
        <section class="px-6 py-2">
            <div class="flex gap-4">
                <div class="flex-1">
                    <label
                        class="block text-[10px] font-bold text-gray-400 uppercase mb-1.5 ml-6 tracking-wider">Periode</label>
                    <div class="relative">
                ...
                <div class="flex-1">
                    <label
                        class="block text-[10px] font-bold text-gray-400 uppercase mb-1.5 ml-6 tracking-wider">Kelas</label>
                    <div class="relative">
