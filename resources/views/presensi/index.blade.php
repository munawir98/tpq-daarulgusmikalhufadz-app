...
<body class="bg-background-light dark:bg-background-dark text-[#0d181c] dark:text-gray-100 min-h-screen pb-32">
    <!-- Header -->
    <header
        class="flex items-center bg-gradient-to-r from-[#1A2980] to-[#26D0CE] h-14 px-4 shadow-lg shadow-blue-900/20 mx-6 rounded-2xl mt-4 mb-4">
    ...
    <form method="GET" action="{{ route('presensi.index') }}" id="filterForm">
        <section class="px-6 py-2">
            <div class="flex gap-4">
                <div class="flex-1">
                    <label
                        class="block text-[10px] font-bold text-gray-400 uppercase mb-1.5 ml-5 tracking-wider">Periode</label>
                    <div class="relative">
                ...
                <div class="flex-1">
                    <label
                        class="block text-[10px] font-bold text-gray-400 uppercase mb-1.5 ml-5 tracking-wider">Kelas</label>
                    <div class="relative">
