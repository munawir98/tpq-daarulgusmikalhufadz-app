    ...
    <div
        ...
        <div class="flex gap-3 max-w-sm mx-auto">
            <a href="{{ route('ustadz.presensi.pdf') }}"
                class="flex-1 flex items-center justify-center gap-2 bg-teal-600 hover:bg-teal-700 text-white py-3.5 px-6 rounded-xl font-semibold shadow-lg shadow-teal-500/20 transition-all active:scale-[0.98]">
                <span class="material-icons-round text-xl leading-none">picture_as_pdf</span>
                <span class="text-base">Cetak PDF</span>
            </a>
            <button
                class="flex-1 flex items-center justify-center gap-2 bg-white dark:bg-slate-800 border-2 border-teal-600 text-teal-600 dark:text-teal-400 py-3.5 px-6 rounded-xl font-semibold transition-all active:scale-[0.98]">
