    ...
    <main class="flex-1 max-w-md mx-auto w-full pb-32">
        ...
        <section class="mt-2">
            ...
            <div id="template-list" class="flex gap-3 px-4 overflow-x-auto no-scrollbar pb-2">
                <button
                    class="flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-full bg-primary ring-1 ring-inset ring-primary text-white px-6 text-xs font-semibold shadow-md shadow-primary/20 whitespace-nowrap">
                    <span class="material-symbols-outlined text-base">event_busy</span>
                    Absensi
                </button>
                <button
                    class="flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-full bg-white ring-1 ring-inset ring-slate-200 text-slate-600 px-6 text-xs font-semibold whitespace-nowrap">
