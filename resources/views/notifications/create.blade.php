    ...
    <main class="flex-1 max-w-md mx-auto w-full pb-32">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center justify-between mb-1">
                            <span
                                class="text-[10px] font-bold uppercase tracking-wider text-amber-600 bg-amber-50 px-2 py-0.5 rounded border border-amber-100">Belum
                                Dihubungi</span>
                        </div>
                        <h2 class="text-lg font-bold leading-none text-slate-900">Ahmad Syarif</h2>
        ...
        <section class="mt-2">
            <div class="px-4 mb-3 flex items-center justify-between">
                ...
                <span class="text-xs font-medium text-primary bg-primary/5 px-2 py-0.5 rounded-full">3 Tersedia</span>
            </div>
