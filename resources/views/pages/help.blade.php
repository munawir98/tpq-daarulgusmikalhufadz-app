    ...
    <details
        ...
        <summary class="flex items-center justify-between p-2.5 cursor-pointer">
            <div class="flex items-center gap-2.5">
                <div class="shrink-0 size-8 rounded-lg bg-primary/10 flex items-center justify-center text-primary">
                    <span class="material-symbols-outlined">location_on</span>
                </div>
                <span class="font-semibold text-[13px] text-[#111813] dark:text-white">Bagaimana cara presensi?</span>
            </div>
            <span
    ...
    <details
        ...
        <summary class="flex items-center justify-between p-4 cursor-pointer">
            <div class="flex items-center gap-3">
                ...
                <span class="font-semibold text-[13px] text-[#111813] dark:text-white">Cara melihat riwayat hafalan?</span>
            </div>
            <span
                class="material-symbols-outlined text-gray-400 group-open:rotate-180 transition-transform">expand_more</span>
        </summary>
    ...
    <details
        ...
        <summary class="flex items-center justify-between p-4 cursor-pointer">
            <div class="flex items-center gap-3">
                ...
                <span class="font-semibold text-[13px] text-[#111813] dark:text-white">Lupa password, bagaimana?</span>
            </div>
            <span
                class="material-symbols-outlined text-gray-400 group-open:rotate-180 transition-transform">expand_more</span>
        </summary>
    ...
    <details
        ...
        <summary class="flex items-center justify-between p-4 cursor-pointer">
            <div class="flex items-center gap-3">
                ...
                <span class="font-semibold text-[13px] text-[#111813] dark:text-white">Notifikasi tidak muncul?</span>
            </div>
            <span
                class="material-symbols-outlined text-gray-400 group-open:rotate-180 transition-transform">expand_more</span>
        </summary>
    ...
    <details
        ...
        <summary class="flex items-center justify-between p-4 cursor-pointer">
            <div class="flex items-center gap-3">
                ...
                <span class="font-semibold text-[13px] text-[#111813] dark:text-white">Hapus sidik jari lama di HP?</span>
            </div>
            <span
                class="material-symbols-outlined text-gray-400 group-open:rotate-180 transition-transform">expand_more</span>
        </summary>
        <div class="px-3 pb-3 text-xs text-gray-600 dark:text-gray-400 leading-relaxed space-y-2">
            ...
            <div class="bg-gray-50 dark:bg-gray-900/50 p-2.5 rounded-xl border border-gray-100 dark:border-gray-700">
                <strong class="block text-gray-800 dark:text-gray-200 mb-1 text-xs">🤖 Android (Google Chrome)</strong>
                <p class="text-[10px] text-gray-500 mb-1.5">Jika tidak ketemu di Pengaturan HP, coba cek di Pengaturan
                    Chrome:</p>
                <ol class="list-decimal list-inside text-[11px] space-y-1">
                    ...
                    <li>Jika masih tidak ada, coba ketik di address bar: <br>
                        <code class="bg-gray-200 px-1 rounded text-[10px]">chrome://settings/passkeys</code>
                    </li>
            ...
            <div class="bg-gray-50 dark:bg-gray-900/50 p-2.5 rounded-xl border border-gray-100 dark:border-gray-700">
                <strong class="block text-gray-800 dark:text-gray-200 mb-1 text-xs">🍎 iOS (iPhone/iPad)</strong>
                <ol class="list-decimal list-inside text-[11px] space-y-1">
            ...
            <div class="bg-gray-50 dark:bg-gray-900/50 p-2.5 rounded-xl border border-gray-100 dark:border-gray-700">
                <strong class="block text-gray-800 dark:text-gray-200 mb-1 text-xs">💻 Windows (Laptop/PC)</strong>
                <ol class="list-decimal list-inside text-[11px] space-y-1">
