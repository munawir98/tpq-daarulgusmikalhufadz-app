...
<body class="bg-gray-100 dark:bg-gray-900 font-display min-h-screen p-0 block">
    <div
        class="relative w-full h-[100dvh] bg-gray-100 dark:bg-[#0f172a] rounded-none overflow-hidden shadow-none flex flex-col">
        ...
        <div
            ...
            <div class="absolute top-[100px] left-[50%] w-32 h-32 bg-[#6BB8DE] rounded-full blur-2xl opacity-30"></div>
        ...
        <div class="relative z-10 flex-1 overflow-y-auto no-scrollbar flex flex-col">
            ...
            <div
                class="w-full bg-white dark:bg-[#1E1E1E] rounded-t-[30px] shadow-[0_-10px_40px_rgba(0,0,0,0.05)] pt-6 px-6 relative z-20 flex-grow min-h-0 pb-[calc(20px+env(safe-area-inset-bottom))] transition-all duration-300">
                ...
                <div class="flex flex-col items-center animate-fade-in-up">
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-6 w-full">
                        <div
                            class="bg-gray-50 border border-gray-100 p-3 rounded-2xl flex items-center space-x-3 shadow-sm">
                            <div
                                class="w-10 h-10 rounded-xl flex items-center justify-center bg-blue-100 text-blue-600">
                        ...
                        <div
                            class="bg-gray-50 border border-gray-100 p-3 rounded-2xl flex items-center space-x-3 shadow-sm">
                            <div
                                class="w-10 h-10 rounded-xl flex items-center justify-center bg-orange-100 text-orange-600">
                    ...
                    <!-- Map -->
                    <div
                        class="w-full h-40 bg-gray-100 rounded-2xl mb-6 relative overflow-hidden border border-gray-200 group">
                    ...
                    <div class="grid grid-cols-2 gap-4 w-full mb-8">
                        ...
                        <button onclick="checkBiometricAndSubmit('pulang')"
                            class="relative flex flex-col items-center justify-center p-5 bg-white border border-gray-100 rounded-2xl shadow-lg text-orange-600 active:scale-95 transition-transform overflow-hidden group">
                    ...
                    <div class="w-full bg-gray-50 border border-gray-100 rounded-2xl p-5 mb-8">
                        ...
                        <form action="{{ route('ustadz.presensi') }}" method="GET">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <div class="relative">
                                        <input type="date" name="start_date"
                                            class="w-full bg-white border border-gray-200 rounded-xl pl-9 pr-3 py-2 text-xs text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all"
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <div
                                    class="bg-white border border-gray-200 rounded-xl px-3 py-2.5 flex flex-col items-center justify-center min-w-[70px]">
                                    <span class="text-[8px] text-gray-500 uppercase tracking-wider">Total Hadir</span>
                                    <span class="text-xs font-bold text-gray-900 leading-none">{{ $totalHadir ?? 0
                                        }}</span>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="w-full pb-8">
                        ...
                        <div class="space-y-3">
                            ...
                            <div
                                class="bg-gray-50 rounded-2xl p-4 flex items-center justify-between shadow-sm border border-gray-100">
                                <div class="flex items-center space-x-4">
                                    <div
                                        ...
                                        <span class="material-icons-round">{{ $item->tipe == 'masuk' ? 'login' :
                                            'logout' }}</span>
                                    </div>
                                    <div>
            ...
            <footer class="text-center text-[10px] text-gray-400 pb-6 bg-white dark:bg-[#1E1E1E]">
