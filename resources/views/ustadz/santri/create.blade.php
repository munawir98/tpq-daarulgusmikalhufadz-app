...
<body class="bg-background-light dark:bg-background-dark min-h-screen font-display">
    <form action="{{ route('ustadz.santri.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <main class="pb-32 px-4 pt-4">
            <div class="bg-white dark:bg-gray-900 rounded-xl p-6 ios-shadow flex flex-col items-center mb-6">
                <div class="relative group">
                    ...
                    $gradientRing = $gradients[0]; // Default gradient
                    @endphp
                    ...
                    <div class="p-[3px] rounded-full bg-gradient-to-tr {{ $gradientRing }} shadow-lg shadow-primary/20">
                        <div
                            ...
                            <div class="w-full h-full bg-center bg-no-repeat bg-cover" id="placeholder-foto"
                                style='background-image: url("https://ui-avatars.com/api/?name=Baru&background=random&color=fff&bold=true&font-size=0.35&rounded=false");'>
                            </div>
            ...
            <div class="space-y-8">
                ...
                <div
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <input type="hidden" name="nama_panggilan" value="{{ old('nama_panggilan') }}">
                ...
                <div
                    ...
                    <div class="p-5 space-y-4">
                        <div class="flex flex-col gap-2">
                            ...
                            <input
                                class="form-input w-full rounded-lg border-[#dbe6e4] dark:border-gray-700 dark:bg-gray-800 dark:text-white h-10 px-4 text-sm focus:ring-0 placeholder:text-slate-300/50 dark:placeholder:text-gray-600/50 placeholder:text-xs placeholder:tracking-tight"
                                placeholder="Nomor Induk Santri" type="text" name="nis" value="{{ old('nis') }}" />
                        </div>
                        <div class="flex flex-col gap-2">
        ...
        <div
            ...
            <button
                class="w-full max-w-[480px] bg-primary hover:brightness-95 active:scale-[0.98] transition-all text-white py-3.5 rounded-xl font-bold text-base shadow-lg shadow-primary/20 flex items-center justify-center gap-2">
