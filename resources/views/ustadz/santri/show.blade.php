...
<div class="space-y-5 pb-20 px-5 pt-6">
    ...
    <div class="space-y-2.5">
        ...
        <a href="{{ route('ustadz.hafalan.show', $hafalan->id) }}"
            class="block bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-slate-800 dark:to-slate-800 px-5 py-3 rounded-xl shadow-sm active:scale-[0.98] transition-all border-l-4 border-blue-500">
            <div class="flex justify-between items-start mb-1">
                <h4 class="font-bold text-gray-800 dark:text-gray-100 text-xs">{{ $hafalan->surah }}</h4>
                <span class="text-xs text-gray-900 dark:text-white bg-white/50 dark:bg-gray-700 px-3 py-1 rounded-full">
