                ...
                <div id="contentInputBaru" class="tab-content">
                    ...
                    <form action="{{ route('ustadz.hafalan.store') }}" method="POST" id="setoranForm"
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <!-- Fixed Submit Button -->
                            <div
                                class="fixed bottom-0 left-0 right-0 px-6 py-4 bg-white/80 dark:bg-surface-dark/80 backdrop-blur-md border-t border-gray-200 dark:border-gray-800 z-40 transform translate-y-0 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
