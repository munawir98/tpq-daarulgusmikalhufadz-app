        ...
        <div class="relative z-10 pt-12 pb-14 px-6">
            <div class="flex items-center justify-center mb-2">
                <div class="text-center text-white">
                    <h1 class="text-2xl font-bold leading-tight">Laporan</h1>
                    <p class="text-sm opacity-75 mt-0.5">Pusat Data &amp; Statistik TPQ</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div
        ...
        <div class="px-6 pt-6 pb-2 shrink-0 bg-card-light dark:bg-card-dark rounded-t-[2.5rem] z-30">
            ...
            <div class="relative mb-4">
                <input id="searchInput"
                    class="w-full bg-gray-50 dark:bg-gray-800 border-none text-xs rounded-2xl py-3 pl-12 pr-4 focus:ring-2 focus:ring-blue-500/50 shadow-sm placeholder-gray-400 text-gray-700 dark:text-gray-200 transition-shadow"
        ...
        <div class="flex-1 overflow-y-auto px-6 pt-2 pb-24" id="reportList">
            <div class="space-y-4">
                ...
                <a class="report-item group block bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-4 shadow-sm hover:shadow-md transition-all duration-200"
                    href="{{ route('ustadz.laporan.kegiatan') }}" data-category="harian bulanan"
