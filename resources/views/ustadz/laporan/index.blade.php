    ...
    <div
        ...
        <div class="flex flex-wrap gap-3 p-4">
            ...
            <a href="{{ route('ustadz.santri.index') }}"
                class="relative flex min-w-[125px] flex-1 flex-col gap-1 rounded-2xl p-3 bg-cyan-500 shadow-lg shadow-cyan-500/20 overflow-hidden group hover:shadow-md transition-all">
            ...
            <div
                class="relative flex min-w-[125px] flex-1 flex-col gap-1 rounded-2xl p-3 bg-emerald-500 shadow-lg shadow-emerald-500/20 overflow-hidden group">
                <div class="relative z-10">
                    <div class="flex items-center justify-between mb-1.5">
                        <div class="p-1 bg-white/20 rounded-lg backdrop-blur-sm">
            ...
            <a href="{{ route('presensi.index') }}"
                class="relative flex min-w-[125px] flex-1 flex-col gap-1 rounded-2xl p-3 bg-amber-500 shadow-lg shadow-amber-500/20 overflow-hidden group hover:shadow-md transition-all">
                <div class="relative z-10">
                    <div class="flex items-center justify-between mb-1.5">
                        <div class="p-1 bg-white/20 rounded-lg backdrop-blur-sm">
            ...
            <a href="{{ route('ustadz.laporan.keuangan') }}"
                class="relative flex min-w-[125px] flex-1 flex-col gap-1 rounded-2xl p-3 bg-indigo-600 shadow-lg shadow-indigo-600/20 overflow-hidden group hover:shadow-md transition-all">
                <div class="relative z-10">
                    <div class="flex items-center justify-between mb-1.5">
                        <div class="p-1 bg-white/20 rounded-lg backdrop-blur-sm">
