...
<body class="bg-background-light dark:bg-background-dark text-[#0e141b] dark:text-slate-100 min-h-screen">
    <div
        ...
        <header
            class="relative flex items-center bg-gradient-to-r from-[#1A2980] to-[#26D0CE] h-14 px-4 sticky top-3 mx-3 mt-3 z-50 shadow-lg shadow-blue-900/20 overflow-hidden rounded-2xl">
            <!-- Pattern Overlay -->
