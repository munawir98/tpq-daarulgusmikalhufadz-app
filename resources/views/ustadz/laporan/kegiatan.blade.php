        ...
        <main class="flex-1 pb-20">
            ...
            <div id="sectionJurnal">
                ...
                <div class="p-8 text-center text-gray-500">
                    <span class="material-symbols-outlined text-5xl text-gray-300 mb-2">edit_note</span>
                    <p class="text-sm">Belum ada jurnal harian.</p>
                </div>
                @endforelse
            </div>
            ...
            <div id="sectionEkskul" class="hidden">
                ...
                @empty
                <div class="p-8 text-center text-gray-500">
                    <span class="material-symbols-outlined text-5xl text-gray-300 mb-2">sports_martial_arts</span>
                    <p class="text-sm">Belum ada kegiatan ekskul.</p>
                </div>
                @endforelse
            </div>
        </main>
