...
<body class="bg-gray-100 dark:bg-gray-900 font-display min-h-screen p-0 block">
    <div
        ...
        <!-- Header Background - Premium Gradient -->
        <div
            class="absolute top-0 left-0 w-full h-[260px] bg-gradient-to-br from-[#1A2980] to-[#26D0CE] z-0 rounded-b-[40px] overflow-hidden">
