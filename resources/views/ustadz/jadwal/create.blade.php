...
<body class="bg-background-light dark:bg-background-dark min-h-screen text-[#111816] dark:text-white pb-32">
    ...
    <form action="{{ route('ustadz.jadwal.store') }}" method="POST" id="jadwalForm">
        ...
        <main class="max-w-md mx-auto pt-4 relative">
            ...
            <!-- Box Header (Standardized Style) -->
            <header
                class="flex items-center justify-center bg-gradient-to-br from-amber-400 to-orange-500 h-16 px-4 shadow-lg shadow-orange-500/20 mx-4 rounded-2xl mb-6 relative z-30">
                <h1 class="text-white text-xl font-bold leading-tight tracking-tight text-center">Tambah Jadwal Baru
                </h1>
            </header>
            ...
            <div class="px-4 space-y-6">
                ...
                <div class="bg-white dark:bg-[#1a2e29] rounded-2xl p-5 shadow-sm space-y-6">
                    ...
                    <!-- Ustadz -->
                    <div class="space-y-2">
                        <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 ml-1">Pilih
                            Ustadz</label>
                        <div class="relative">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <!-- Jam Mulai -->
                        <div class="space-y-2">
                            <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 ml-1">Jam
                                Mulai</label>
                            <div class="relative">
