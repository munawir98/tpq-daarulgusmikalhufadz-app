...
<body class="bg-gray-900 min-h-screen overflow-hidden m-0 p-0">
    ...
    <div class="absolute inset-0 z-50 pointer-events-none flex flex-col items-center justify-center">
        ...
        <div class="relative w-[280px] h-[280px] sm:w-[320px] sm:h-[320px] box-content z-30">
            ...
            <!-- Top Left -->
            <div
                class="absolute top-0 left-0 w-2 h-2 z-40 bg-[radial-gradient(circle_at_100%_100%,transparent_7px,rgba(0,0,0,0.8)_8px)]">
            </div>
            <!-- Top Right -->
            <div
                class="absolute top-0 right-0 w-2 h-2 z-40 bg-[radial-gradient(circle_at_0%_100%,transparent_7px,rgba(0,0,0,0.8)_8px)]">
            </div>
            <!-- Bottom Left -->
            <div
                class="absolute bottom-0 left-0 w-2 h-2 z-40 bg-[radial-gradient(circle_at_100%_0%,transparent_7px,rgba(0,0,0,0.8)_8px)]">
            </div>
            <!-- Bottom Right -->
            <div
                class="absolute bottom-0 right-0 w-2 h-2 z-40 bg-[radial-gradient(circle_at_0%_0%,transparent_7px,rgba(0,0,0,0.8)_8px)]">
            </div>
