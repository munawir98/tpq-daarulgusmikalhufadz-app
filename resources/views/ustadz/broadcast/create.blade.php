            ...
            <div id="specificSantriSection"
                ...
                <div class="flex-1 relative">
                    <input type="text" id="santriSearchInput" placeholder="Ketik nama santri..." autocomplete="off"
                        class="w-full bg-transparent border-0 border-b border-gray-300 focus:ring-0 p-0 text-[11px] font-bold placeholder:font-normal">
            ...
            <section class="mt-4">
                ...
                <div class="flex gap-2 px-6 overflow-x-auto no-scrollbar pb-3 mask-linear scroll-smooth"
                    ...
                    <button type="button" onclick="setTemplate('Izin Sakit', this)"
                        class="template-btn flex items-center justify-center rounded-full bg-white border border-slate-200 text-slate-600 px-4 py-2 text-[10px] font-medium whitespace-nowrap hover:bg-slate-50 shrink-0 transition-all">
                        Izin Sakit
                    </button>
            ...
            <section class="px-6 py-4 mt-2">
                ...
                <div
                    ...
                    <textarea name="content" id="messageContent"
                        class="w-full bg-transparent border-none focus:ring-0 text-slate-700 p-4 min-h-[180px] text-[11px] leading-relaxed resize-none"
                ...
                <div class="grid grid-cols-2 gap-3">
                    <button type="button" onclick="sendWhatsApp()"
                        ...
                        <div class="flex items-center gap-1.5">
                            ...
                            <span class="text-[10px] font-bold leading-none">WhatsApp</span>
                        </div>
                    </button>
                    <button type="submit"
                        ...
                        <div class="flex items-center gap-1.5">
                            ...
                            <span class="text-[10px] font-bold leading-none text-center">Notifikasi App</span>
                        </div>
                    </button>
                </div>
            </div>
    ...
    <script>
        ...
        function setTemplate(type, btnElement) {
            ...
            document.querySelectorAll('.template-btn').forEach(btn => {
                ...
                btn.className = "template-btn flex items-center justify-center rounded-full bg-white border border-slate-200 text-slate-600 px-4 py-2 text-[10px] font-medium whitespace-nowrap hover:bg-slate-50 shrink-0 transition-all";
            });

            // Set active state
            if (btnElement) {
                btnElement.className = "template-btn flex items-center justify-center rounded-full bg-primary text-white px-4 py-2 text-[10px] font-semibold whitespace-nowrap shadow-sm shadow-primary/20 shrink-0 transition-all";
                // Scroll into view
                        ...
                        .then(data => {
                            ...
                            if (data.length > 0) {
                                data.forEach(santri => {
                                    ...
                                    div.innerHTML = `
                                        <p class="text-[11px] font-bold text-slate-800">${santri.nama_lengkap}</p>
                                        <p class="text-[10px] text-slate-500">${santri.nis}</p>
                                    `;
                                    div.onclick = () => {
