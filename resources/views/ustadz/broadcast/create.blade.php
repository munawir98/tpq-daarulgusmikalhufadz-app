...
<body class="bg-white text-slate-900 min-h-screen flex flex-col">
    <form action="{{ route('ustadz.broadcast.store') }}" method="POST" class="flex flex-col flex-1 h-full">
        @csrf
        <header
            class="flex items-center bg-gradient-to-r from-[#1A2980] to-[#26D0CE] h-14 px-6 sticky top-4 z-50 shadow-lg shadow-blue-900/20 mx-6 mb-4 rounded-2xl overflow-hidden">
            <!-- Pattern Overlay -->
            ...
            <section class="bg-white border border-slate-100 rounded-2xl p-4 shadow-sm">
                ...
                <div id="specificSantriSection"
                    ...
                    <div class="flex-1 relative">
                        ...
                        <p id="nisDisplay" class="text-[10px] text-slate-500 font-medium">Nomor NIS</p>
                            ...
                            if (data.length > 0) {
                                data.forEach(santri => {
                                    ...
                                    div.onclick = () => {
                                        ...
                                        if (document.getElementById('nisDisplay')) {
                                            document.getElementById('nisDisplay').innerText = santri.nis;
                                        }
                                        searchResults.classList.add('hidden');
                                    };
