        ...
        <footer class="fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-slate-100 z-50">
            <div class="max-w-md mx-auto flex flex-col gap-3">
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <button type="submit"
                        class="flex-1 h-14 bg-emerald-600 hover:brightness-105 active:scale-[0.96] transition-all rounded-xl flex flex-col items-center justify-center text-white shadow-sm px-2">
                        <div class="flex items-center gap-1.5">
