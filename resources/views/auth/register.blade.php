                ...
                <div class="min-h-full w-full flex flex-col items-center justify-start px-4 pt-2 pb-6 lg:p-8">
                    ...
                    <div class="w-full max-w-md relative">
                        ...
                        <div class="text-center mb-6">
                            <h1
                                class="text-lg lg:text-2xl font-bold text-white lg:text-gray-800 dark:lg:text-white tracking-tight">
                                Buat Akun Baru
                            </h1>
                            ...
                            <form id="registerForm" method="POST" action="{{ route('register') }}" class="space-y-2.5">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                                    ...
                                    <button id="registerButton" type="submit"
                                        class="w-full h-[42px] bg-white lg:bg-gradient-to-r lg:from-primary lg:to-primary-dark text-primary lg:text-white hover:bg-white/90 lg:hover:shadow-lg lg:hover:shadow-primary/30 rounded-xl font-bold text-xs shadow-lg shadow-black/10 transform active:scale-[0.98] transition-all flex items-center justify-center gap-2 group">
