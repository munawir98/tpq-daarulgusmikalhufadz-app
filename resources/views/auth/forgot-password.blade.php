...
<head>
    ...
    <title>Lupa Kata Sandi - TPQ Digital</title>
...
<div class="flex-1 flex flex-col items-center justify-center px-4 w-full pb-10">

    <!-- Card Container -->
    <div
        class="w-full max-w-md bg-white dark:bg-gray-800 rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-black/30 border border-gray-100 dark:border-gray-700 p-6 sm:p-8 flex flex-col gap-6 transition-colors duration-200">

        <!-- Headline & Illustration -->
        <div class="flex flex-col items-center text-center">
            <div
                class="flex h-20 w-20 items-center justify-center rounded-full bg-primary/10 mb-5 ring-8 ring-primary/5">
            ...
            <p class="text-gray-500 dark:text-gray-400 text-sm leading-relaxed max-w-[300px]">
                Jangan khawatir. Masukkan email yang terdaftar di TPQ, kami akan mengirimkan kode verifikasi ke
                email Anda.
            </p>
        </div>
        ...
        @if($errors->any())
        <div
            class="w-full p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl text-red-600 dark:text-red-400 text-sm text-center">
            {{ $errors->first() }}
        </div>
        @endif

        <!-- Form Section -->
        <form action="/forgot-password" method="POST" class="flex flex-col gap-4 w-full">
            @csrf
            ...
            <div class="flex flex-col w-full gap-2">
                ...
                <div class="relative">
                    ...
                    <input name="email" type="email" value="{{ old('email') }}" required
                        class="block w-full pl-11 pr-4 py-3.5 rounded-2xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm placeholder-gray-400 transition-all"
                        placeholder="Contoh: santri@tpq.com" />
                </div>
            </div>
